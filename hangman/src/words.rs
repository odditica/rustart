...
#[derive(Debug)]
pub struct Word {
    pub uppercased_word: String,
    pub graphemes: Vec<&'static str>,
}

pub fn get_random_word() -> Vec<String> {
    let mut generator = rand::thread_rng();
    let index: usize = generator.gen_range(0..WORD_LIST.len());
    ...
    return graphemes.iter().map(|x| x.to_string()).collect();
}
